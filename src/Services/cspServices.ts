export default class CspService {
  ...
  img-src 'self' data:;
  connect-src 'self' https://stingray-app-69yxe.ondigitalocean.app http://localhost:8000/api/ wss://ws.simplists.net https://fonts.googleapis.com https://fonts.gstatic.com;
  base-uri 'self';
  object-src 'none';
`;
